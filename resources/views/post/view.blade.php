        ...
        <div class="mx-auto max-w-2xl lg:max-w-5xl">
          <div class="xl:relative">
            <div class="mx-auto max-w-2xl">
              <button @click="history.back()" type="button" aria-label="Go back to articles" class="group mb-8 flex h-10 w-10 items-center justify-center rounded-full bg-white shadow-md shadow-zinc-800/5 ring-1 ring-zinc-900/5 transition lg:absolute lg:-left-5 lg:-mt-2 lg:mb-0 xl:-top-1.5 xl:left-0 xl:mt-0 dark:border dark:border-zinc-700/50 dark:bg-zinc-800 dark:ring-0 dark:ring-white/10 dark:hover:border-zinc-700 dark:hover:ring-white/20">
              ...
              <article>
                <header class="flex flex-col">
                  ...
                  <time datetime="2022-09-05" class="order-first flex items-center text-base text-zinc-400 dark:text-zinc-500">
                    ...
                    <span class="ml-3">{{ $post->getFormatedDate() }}</span>
                  </time>
                </header>
                <div class="mt-8 prose dark:prose-invert mt-6 text-base text-zinc-600 dark:text-zinc-400" data-mdx-content="true">
